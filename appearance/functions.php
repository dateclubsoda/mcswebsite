...
function blankslate_setup() {
    ...
    register_nav_menus(
        ...
        'mobile-menu' => esc_html__( 'Mobile Menu', 'blankslate' ),
        'mobile-menu-popup' => esc_html__( 'Mobile Menu Popup', 'blankslate' ),
        'main-menu-footer' => esc_html__( 'Main Menu Footer', 'blankslate' )
        )
    );
}
